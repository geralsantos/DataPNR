                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3  col-sm-8">
                              <input type="date" class="form-control dtp_fecha_indicador_12" placeholder="YYYY-MM-DD" v-model="fecha" id="" @onchange="geral()">
                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    <td v-for="promedio in promedios">{{promedio.value}}</td>
                                </tr>
                            </tbody>
                            </table>
                        </div>
...
Tiempo Promedio de Espera del Ciudadano por Trámite</strong>
                  ...
                  <div class="card-body card-block">
                      <div id="indicador_12" style="min-width: 300px; height: 400px; margin: 0 auto"></div>
                  </div>
