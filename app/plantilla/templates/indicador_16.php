                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <div class=""><label for="text-input" class=" form-control-label">Sugerencias Reportadas</label>
                                        <input type="number" id="sugerencias_reportadas" v-model="sugerencias_reportadas" name="sugerencias_reportadas" placeholder="" class="form-control"> </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <div class=""><label for="text-input" class=" form-control-label">Sugerencias Respondidas</label>
                                    <input type="number" id="sugerencias_respondidas" v-model="sugerencias_respondidas" name="sugerencias_respondidas" placeholder="" class="form-control"> </div>
                                </div>
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                <div id="grafico_16" style="min-width: 300px; height: 400px; margin: 0 auto"></div>
                            </div>
                        </div>
                    </div>
                </div>
